    ...
    >
      ...
      <Flex p="xl" gap="md" direction="column">
        ...
        <Text>
          ...
          dashboard. It is best used when you want to combine multiple visualizations
          together.
        </Text>
        <Text>
          The only property on the dashboard is its{" "}
          <Code>dashboardId</Code>. For example, the React code for the
          above dashboard is as follows.
        </Text>
        <Prism language="tsx">
          {
            '<DataShareDashboard dashboardId="ed934b83-32ca-4a4f-80eb-ce0804632f14" />'
        ...
        <Text>
          If you are looking to build a visualization into other content, you will likely be better
          served by using a standalone <Link href="/visualization">DataShareVisualization</Link>.
        </Text>
      </Flex>
    </Flex>
  );
